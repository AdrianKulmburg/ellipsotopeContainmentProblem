function [res,cert,scaling] = venumSearchEllipsoid(Z1, E, tol, scalingToggle)
% Solves the zonotope containment problem by checking whether the maximum
% value of the Z2-norm at one of the vertices of Z1 exceeds 1+tol. This is
% done via a search algorithm.
